...
public class Vente implements Serializable {
	...
	public Vente(long id, int annee, int numero, Date date_mvt, String nom, String addresse, String ville, String codep,
	...
	public Vente(int annee, int numero, Date date_mvt, String nom, String addresse, String ville, String codep,
			String tel, String tel1, double totht, double tottva, double totttc, String modreg, List<Lvente> lventes) {
		super();
		this.annee = annee;
		this.numero = numero;
